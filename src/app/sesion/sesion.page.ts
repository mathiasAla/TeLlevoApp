...
export class SesionPage implements OnInit {
  ...
  agregarViaje() {
    ...
    setTimeout(() => {
      this.router.navigate(['/pedir-viaje']);  // para ir a la otra pagina.
  ...
  agregarYLogin() {
    const isAuthenticated = this.login(); // Cambia a true o false según el resultado de la función login
  
    if (isAuthenticated) {
      this.agregarViaje(); // Solo llamar a agregarViaje si el inicio de sesión fue exitoso
    }
  }
}
